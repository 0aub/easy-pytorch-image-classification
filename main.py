...
def main(exp, dataset_name, model_name, train_opt=True, eval_opt=True, save=True, overwrite=True, batch_size=16, image_size=256, learning_rate=0.0001, epochs=100, printing=True, return_acc=False, checkpoint_path='./results/checkpoints', log_path='./results/log', comet=None):
    """
